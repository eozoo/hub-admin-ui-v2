  ...
  <el-dialog title="部门管理日志" :visible.sync="visible" width="900px" top="5vh">
    <el-form ref="form" :model="info" label-width="100px" size="mini">
      ...
      <el-row>
        <el-col :span="24">
          <!--     新增     -->
          <el-form-item v-if="info.opAction === 'op_create'" label="部门信息：">
            <el-form ref="form-add" :model="info.request.body" label-width="100px" style="background-color: #e5f3f3">
              <el-row>
                <el-col :span="10">
                  <el-form-item label="部门名称：">{{ info.request.body.deptName }}</el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item label="部门电话：">{{ info.request.body.deptPhone }}</el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="10">
                ...
                <el-col :span="10">
                  <el-form-item label="部门地址：">{{ info.request.body.deptAddr }}</el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="20">
          ...
          <el-form-item v-if="info.opAction === 'op_edit'" label="修改前：">
            <el-form ref="form-before" label-width="100px" style="background-color: #e5f3f3">
              <el-row>
                <el-col :span="10">
                  <el-form-item label="部门名称：">{{ info.opContent.deptName }}</el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item label="部门电话：">{{ info.opContent.deptPhone }}</el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="10">
                ...
                <el-col :span="10">
                  <el-form-item label="部门地址：">{{ info.opContent.deptAddr }}</el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="20">
...
<script>
import { getDeptNames } from '@/api/system/dept'
    ...
    show(info) {
      ...
      if (this.info.opAction === 'op_create') {
        if (info.request.body.parentIds && info.request.body.parentIds.length > 0) {
          getDeptNames(info.request.body.parentIds).then(response => {
      ...
      if (this.info.opAction === 'op_edit') {
        ...
        if (info.opContent.parentIds && info.opContent.parentIds.length > 0) {
          getDeptNames(info.opContent.parentIds).then(response => {
