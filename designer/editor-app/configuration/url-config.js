...
FLOWABLE.URL = {
    ...
    getModel: function(modelId) {
        return FLOWABLE.CONFIG.contextRoot + '/api/v1/flow/designer/info/' + modelId + '/?version=' + Date.now();
    },
    ...
    putModel: function(modelId) {
        return FLOWABLE.CONFIG.contextRoot + '/api/v1/flow/designer/save/' + modelId;
    },

    validateModel: function(){
		return FLOWABLE.CONFIG.contextRoot + '/api/v1/flow/designer/validate';
    },
